...
def the_gui():
    ...
    login = [
        [sg.Frame(layout=[
            [sg.Text('Post from:', size=(17, 1), font=("Roboto", 8)),
             sg.InputCombo(('9gag', 'Instagram user'), default_value="Instagram user", key="post_source", size=(25, 1))],
            [sg.Text('How will you sign in:', size=(17, 1), font=("Roboto", 8)),
             sg.InputCombo(('Facebook', 'Instagram Login'), default_value="Instagram Login", key="login_type",
                           size=(25, 1))],
            ...
            title='Instagram Login', title_color="#00ff00")], ]

    # Output Console
    output = [
        [sg.Frame(layout=[
            [sg.Output(size=(42, 14), pad=(0, 0))],
        ], title='Logs', title_color="#00ff00")], ]
    ...
    layout = [
        ...
        #              pad=(0, 0))],
        # ], title='Help', title_color="#00ff00")],

        # 9gag Section
        [sg.Frame(layout=[
            [sg.Checkbox('coding', key="coding"), sg.Checkbox('programming', key="programming"),
             sg.Checkbox('code', key="code"), sg.Checkbox('codingmemes', key="codingmemes"),
             sg.Checkbox('hacking', key="hacking"), sg.Checkbox('hackermemes ', key="hackermemes"),
             sg.Checkbox('hackingmemes', key="hackingmemes")],
            [sg.Checkbox('htmlmemes', key="htmlmemes"), sg.Checkbox('javascriptmemes', key="javascriptmemes"),
             sg.Checkbox('reactmemes', key="reactmemes"), sg.Checkbox('linux', key="linux"),
             sg.Checkbox('linuxmemes', key="linuxmemes"), sg.Checkbox('computers', key="computers"),
             sg.Checkbox('computermemes', key="computermemes")],
            [sg.Checkbox('gamingmemes', key="gamingmemes"), sg.Checkbox('programmingjokes', key="programmingjokes"),
             sg.Checkbox('codingjokes', key="codingjokes"), sg.Checkbox('codinghumour', key="codinghumour"),
             sg.Checkbox('programminghumour', key="programminghumour")],
        ], title='9gag', title_color="#00ff00")],
        ...
        ], title='Instagram Scrapping', title_color="#ff0000"), sg.Column(login)],
        ...
        ], title='General Options', title_color="#00ff00"), sg.Column(output)],
        # Buttons
        [sg.Button('Run', size=(10, 1), key="Run"), sg.Button('Exit', size=(10, 1))]
    ]
    # Window options
    window = sg.Window('Made with love by Mastermindx33', layout, default_element_size=(40, 1), grab_anywhere=False,
                       location=(255, 100))
